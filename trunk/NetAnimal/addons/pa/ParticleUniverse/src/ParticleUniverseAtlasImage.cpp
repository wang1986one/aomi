...
namespace ParticleUniverse
{
	...
	void AtlasImage::_compile (void)
	{
		...
		size_t imageColums = (size_t)(Ogre::Math::Ceil(Ogre::Math::Sqrt((Ogre::Real)mImageList.size())));
		size_t imageRows = (size_t)(Ogre::Math::Ceil((Ogre::Real)(mImageList.size()) / (Ogre::Real)imageColums));
