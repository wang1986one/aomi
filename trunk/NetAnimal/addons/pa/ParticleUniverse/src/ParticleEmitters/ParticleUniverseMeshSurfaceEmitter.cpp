...
namespace ParticleUniverse
{
	...
	const size_t MeshInfo::getRandomTriangleIndex (void)
	{
		...
		{
			index = (size_t)getGaussianRandom((Ogre::Real)_triangles.size() - 1);
		}
		else
			index = (size_t)Ogre::Math::RangeRandom(0.0f, (Ogre::Real)(_triangles.size() - 1));
    ...
    //-----------------------------------------------------------------------
	unsigned short MeshSurfaceEmitter::_calculateRequestedParticles(Ogre::Real timeElapsed)
	{
		if (mMeshInfo)
		{
