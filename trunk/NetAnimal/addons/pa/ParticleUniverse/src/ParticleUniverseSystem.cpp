...
/*
		...
		Ogre::LogManager::getSingleton().logMessage("ParticleSystem " + 
			getName() + 
			", templatename " + 
			getTemplateName() + 
			": Push event " + 
...
*/
	...
	//-----------------------------------------------------------------------
	void ParticleSystem::start(Ogre::Real stopTime)
	{
		start();
		stop(stopTime);
	}
	//-----------------------------------------------------------------------
	void ParticleSystem::startAndStopFade(Ogre::Real stopTime)
	{
		start();
		stopFade(stopTime);
	}
	...
	//-----------------------------------------------------------------------
	void ParticleSystem::stopFade(Ogre::Real stopTime)
	{
		setFixedTimeout(stopTime);
		mStopFadeSet = true;
	}
	...
	//-----------------------------------------------------------------------
	bool ParticleSystem::hasExternType(const Ogre::String& externType) const
	{
		ParticleTechniqueConstIterator it;
		for (it = mTechniques.begin(); it != mTechniques.end(); ++it)
		{
