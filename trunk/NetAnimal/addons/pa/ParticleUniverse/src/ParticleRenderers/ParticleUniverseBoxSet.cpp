		...
		if (!box.mOwnDimensions)
		{
			for (size_t i = 0; i < 16; ++i)
			{
				...
				*mLockPtr++ = corner.z + box.mPosition.z;
				...
				// Normal
				// TODO: The normal calculation code is not complete. The box deforms if the dimensions change.
//				Ogre::Vector3 orientedVertex = box.mOrientation * Ogre::Vector3(corner.x, corner.y, corner.z);
