...
{
	//-----------------------------------------------------------------------
	bool EntityRendererTranslator::translateChildProperty(Ogre::ScriptCompiler* compiler, const Ogre::AbstractNodePtr &node)
	{
	...
	//-----------------------------------------------------------------------
	bool EntityRendererTranslator::translateChildObject(Ogre::ScriptCompiler* compiler, const Ogre::AbstractNodePtr &node)
	{
		// No objects
		return false;
	}
	...
	void EntityRendererWriter::write(ParticleScriptSerializer* serializer, const IElement* element)
	{
		...
		{
			Ogre::String orientationType = token[TOKEN_ENT_ORIENTED_SELF];
