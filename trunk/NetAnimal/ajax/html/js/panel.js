...
panelDatas["xian"] = {text:'闲',num:0, rate:2};
panelDatas["he"] = {text:'和',num:0, rate:8};

panelDatas["red_lion"] = {text:'红色狮子',num:0, rate:46};
panelDatas["green_lion"] = {text:'绿色狮子',num:0, rate:40};
