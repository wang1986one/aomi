...
//void WheelAnimalUI::updateUIData(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8)
//{
//
//	if(_listener)
//		_listener->updateUIData(  p0,   p1,   p2,   p3,   p4,   p5,   p6,   p7,   p8);
//}
//void WheelAnimalUI::uploadPassword(int password)
//{
//	if(_listener)
...
//void WheelAnimalUI::setMenuDataVisible(bool visible)
//{
//	if(visible)
//		_dan->show();
//	else
//		_dan->hide();
//}
//void WheelAnimalUI::menuResult(bool result)
//{
//	_dan->result(result);
//}
//void WheelAnimalUI::writeMenuXY(int x, int y, unsigned long n)
//{
...
void WheelAnimalUI::addTVUI(WheelEnum::ANIMAL_ITEM item)
{
	_TVUI->add(item);
}