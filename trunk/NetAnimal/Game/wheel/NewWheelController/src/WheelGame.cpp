...
//}
WheelGame::WheelGame(EventWorld * world,  WheelEngineInterfacePtr engine, WheelClockPtr clock):_world(world), _engine(engine), _clock(clock)
{
...
//{
//	//_ui->writeMenuXY(int(item) -1,9,data);
//}
...
{
	NewHardware::getInstance().answerTime(_clock->getLastSecond());
}
//
