...
struct UnitTestEnvironmen{
	...
	{ 
		...
		system.reset(new SystemList<boost::mpl::list<SimpleTimerManager, OgreGraphicsManager, CEGUIManager, OISInputManager, FmodSoundManager, PluginsManager> >());
		...
		PluginsManager::getSingleton().loadPlugin("GameNeedleComponent");
