...
class _OrzWheelControlleExport Process
{
public:
	Process(EventWorld * world, Event::message_type enable,  Event::message_type disable, TimeType minTime = 0.5f, TimeType maxTime = 100.0f);
	~Process(void);
