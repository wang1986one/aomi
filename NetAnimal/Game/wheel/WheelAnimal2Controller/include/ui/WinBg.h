		  ...
		  void show(int i)
		  {
				  ...
				  )
			  {
				  if(i == 0)
				  {
					  ...
					  WheelEnum::AnimalItem  ai = WinData::getInstance().getAnimalItem();
			  ...
			  else if(WinData::getInstance().getWinMode() == WheelEnum::ALL_ANIMAL)
			  {
				  if( i == 0)
				  {
					  WheelEnum::AnimalItem ai = std::make_pair(WinData::getInstance().getAnimalItem().first,WheelEnum::Red);
					  _main->setProperty("Image", _picture[ai]);
				  ...
				  {
					  WheelEnum::AnimalItem ai = std::make_pair(WinData::getInstance().getAnimalItem().first,WheelEnum::Yellow);
					  _main->setProperty("Image", _picture[ai]);
					  int n = WinData::getInstance().getRate(ai);
					  _number.showWinnerNum(n);
					  _all->show();
				  ...
				  {
					  WheelEnum::AnimalItem ai = std::make_pair(WinData::getInstance().getAnimalItem().first,WheelEnum::Green);
					  _main->setProperty("Image", _picture[ai]);
					  int n = WinData::getInstance().getRate(ai);
					  _number.showWinnerNum(n);
					  _all->show();
			  ...
			  else if(WinData::getInstance().getWinMode() == WheelEnum::ALL_COLOR)
			  {
				  if( i == 0)
				  {
					  WheelEnum::AnimalItem ai = std::make_pair(WheelEnum::RABBIT,WinData::getInstance().getLightColor());
					  _main->setProperty("Image", _picture[ai]);
					  int n = WinData::getInstance().getRate(ai);
					  _number.showWinnerNum(n);
					  _all->show();
				  ...
				  {
					  WheelEnum::AnimalItem ai = std::make_pair(WheelEnum::MONKEY,WinData::getInstance().getLightColor());
					  _main->setProperty("Image", _picture[ai]);
					  int n = WinData::getInstance().getRate(ai);
					  _number.showWinnerNum(n);
					  _all->show();
				  ...
				  }else if(i == 2)
				  {
					  ...
					  WheelEnum::AnimalItem ai = std::make_pair(WheelEnum::PANDA,WinData::getInstance().getLightColor());
					  _main->setProperty("Image", _picture[ai]);
					  int n = WinData::getInstance().getRate(ai);
					  _number.showWinnerNum(n);
					  _all->show();
				  ...
				  {
					  WheelEnum::AnimalItem ai = std::make_pair(WheelEnum::LION,WinData::getInstance().getLightColor());
					  _main->setProperty("Image", _picture[ai]);
					  int n = WinData::getInstance().getRate(ai);
					  _number.showWinnerNum(n);
					  _all->show();
			  ...
			  }else if(WinData::getInstance().getWinMode() == WheelEnum::MANY)
			  {
				  if(size_t(i) < WinData::getInstance().size()/*WheelData::getInstance().hasTVNext(WinData::getInstance().getWinMode(), WinData::getInstance().getAnimalItem(), i)*/)
				  {
					  ...
					  WheelEnum::AnimalItem ai = WinData::getInstance().getAnimalItem(i);
					  _main->setProperty("Image", _picture[ai]);
					  int n = WinData::getInstance().getRate(ai);
					  _number.showWinnerNum(n);
					  _all->show();
			...
			else
			{
				...
				if(WinData::getInstance().getWinMode() == WheelEnum::NONE)
				{
					...
					if(table >=0 &&  table <=8)
					{
						...
						CEGUI::WindowManager::getSingleton().getWindow("Win/Bg/Winner/Table")->setProperty("Image","set:AnimalUIEX image:Table"+boost::lexical_cast<std::string>(table));


						CEGUI::WindowManager::getSingleton().getWindow("Win/Bg/Winner/Table")->show();
					}
				}
			}
