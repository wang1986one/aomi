...
public:
	...
	virtual std::string getLightLiang(int i);
	virtual std::string getLightAn(int i);
	
	virtual std::string getTable(int i);
	virtual std::string getTableLiang(int i);
	virtual std::string getTableAn(int i);
	...
	virtual WheelEnum::AnimalType getAnimalType(int n) = 0;
