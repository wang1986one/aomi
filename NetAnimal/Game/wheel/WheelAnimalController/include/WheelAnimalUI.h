...
namespace Orz
{
	...
	class Light;
	/*class Dan2;*/
	class _OrzWheelAnimalControllerExport WheelAnimalUI: public WheelUIInterface/*, public DanListener*/, public Singleton<WheelAnimalUI>
	{
	public:
		...
		void addTVUI(WheelEnum::ANIMAL_ITEM item);
	...
	private:
	//	typedef std::map<std::pair<WheelEnum::ANIMAL_TYPE, WheelEnum::LIGHT_COLOR>, int> UIMap;
	//	UIMap _uiMap;
