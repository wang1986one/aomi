//						  
//#ifndef __Orz_Animal_AnimalManagerImpl_h__
//#define __Orz_Animal_AnimalManagerImpl_h__
// 
//#include "WheelObjectConfig.h"
//#include "./AnimalManager.h"
//namespace Orz
//{
//class Animal_AnimalManagerImpl
//{
//public:
//	Animal_AnimalManagerImpl(void);
//	~Animal_AnimalManagerImpl(void);
//
//	AnimalPtr createAnimal(WheelEnum::ANIMAL_TYPE type, Ogre::SceneNode * sn);
//
//
//private:
//
//	std::string getMeshName(WheelEnum::ANIMAL_TYPE type);
//
