...
//
//
//std::string Animal_AnimalManagerImpl::getMeshName(WheelEnum::ANIMAL_TYPE type)
//{
...
//
//
//AnimalPtr Animal_AnimalManagerImpl::createAnimal(WheelEnum::ANIMAL_TYPE type, Ogre::SceneNode * sn)
//{
//
//	static int id = 0;
