...
WheelAnimalGame::WheelAnimalGame(void)
{
	...
	AnimalChangePtr ac(
		new AnimalChange(
		am->createAnimal(WheelEnum::ANIMAL_TYPE(WheelEnum::LION, WheelEnum::PEOPLE), 
		node
	...
	ac->insertAnimal(
		am->createAnimal(
		WheelEnum::ANIMAL_TYPE(WheelEnum::RABBIT, WheelEnum::PEOPLE), 
		node)
		);

	ac->insertAnimal(
		am->createAnimal(
		WheelEnum::ANIMAL_TYPE(WheelEnum::MONKEY, WheelEnum::PEOPLE), 
		node	
		)
		);
	...
	ac->insertAnimal(
		am->createAnimal(
		WheelEnum::ANIMAL_TYPE(WheelEnum::PANDA, WheelEnum::PEOPLE), 
		node
		)
		);
