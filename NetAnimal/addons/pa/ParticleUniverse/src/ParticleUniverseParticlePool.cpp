...
namespace ParticleUniverse
{
	...
	{
		Ogre::vector<VisualParticle*>::type::iterator it;
	...
	{
		Ogre::vector<ParticleEmitter*>::type::iterator itEmitter;
	...
	{
		Ogre::vector<ParticleTechnique*>::type::iterator itTechnique;
	...
	{
		Ogre::vector<ParticleAffector*>::type::iterator itAffector;
	...
	void ParticlePool::destroyAllSystemParticles(void)
	{
		...
		Ogre::vector<Ogre::String>::type::iterator itSystem;
